	...
	public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException {
		try {
			...
			while(rs.next()) {
				...
				+ "<input type=hidden name=nam value="+name+">"
				+ "<input type=hidden name=nic value="+nick+">"
				+ "<input type=hidden name=add value="+addr+">"
				+ "<input type=submit name=editadd value=Edit>"
				+ "</form>"
				+ "</td>"
				+ "<td>"
				+ "<form action=deleteadd  method=post>"
				+ "<input type=hidden name=del value="+addr+">"
			...
			out.println("<a class='addbutton' href='addnew.html'>Add</a>");
