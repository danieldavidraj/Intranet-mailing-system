...
public class editfolder extends HttpServlet {
	...
	public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException {
		try {
			...
			out.println("<form action=changefolder method=post> <img src='https://s3-us-west-2.amazonaws.com/shipsy-public-assets/shipsy/SHIPSY_LOGO_BIRD_BLUE.png' id='signupLogo'/>");
			
			out.println("<h2 class='formTitle'>Changing the Folder name</h2>");

			out.println("<div class='inputDiv'> <label class='inputLabel' for='oldfolder'>OldFolderName</label> <input type='text' id='oldfolder' name='oldfolder' value="+folder+"> </div>");
			out.println("<div class='inputDiv'> <label class='inputLabel' for='newfolder'>NewFolderName</label> <input type='text' id='newfolder' name='newfolder'> </div>");
		
			out.println("<div class='buttonWrapper'> <button type='submit' id='submitButton' class='submitButton pure-button pure-button-primary'> <span>Continue</span> </button> </div> </form> </div> </div></body></html>");
